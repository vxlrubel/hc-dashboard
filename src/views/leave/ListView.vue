...
import LeaveAction from './LeaveAction.vue'
...
if (pageParam) {
  leaveStore.page = Number(pageParam)
} else {
  leaveStore.page = 1
}
...
const { paginatedLeaves, page, itemsPerPage, totalLeaves, buikLoading, deletingIds } =
...
<template>
  <div>
    <PageTitle title="Leave List" subtitle="View and manage all leave requests.">
      <RouterLink to="/dashboard/leave/add">
        <Button class="button-primary-outline">Add New Leave</Button>
      </RouterLink>
    </PageTitle>
      ...
      <Table>
        <TableHeader>
          <TableRow>
            ...
            <TableHead class="min-w-40">Employee</TableHead>
            <TableHead class="min-w-25">Type</TableHead>
            <TableHead class="min-w-55">Reason</TableHead>
            <TableHead class="min-w-30">Start</TableHead>
            <TableHead class="min-w-30">End</TableHead>
            <TableHead class="min-w-35">Status</TableHead>
            <TableHead class="min-w-35">Approved By</TableHead>
        ...
        <TransitionGroup tag="tbody" name="row">
          ...
          >
            ...
            <TableCell><span v-html="ukFormat(startDate)"></span></TableCell>
            <TableCell><span v-html="ukFormat(endDate)"></span></TableCell>
            <TableCell>
