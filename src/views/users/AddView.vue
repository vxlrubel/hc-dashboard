...
const { createLoading } = storeToRefs(userStore)
...
<template>
  <div>
    <PageTitle title="Add User" subtitle="Create a new user account.">
    ...
    <form @submit="onSubmit">
      <Card class="w-full max-w-2xl mx-auto mt-10">
        <CardHeader>
          ...
          <CardDescription>Create a new user account with valid input.</CardDescription>
        </CardHeader>
        <CardContent>
