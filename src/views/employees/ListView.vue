...
import EmployeeAction from './EmployeeAction.vue'
...
if (pageParam) {
  employeeStore.page = Number(pageParam)
} else {
...
const { paginatedEmployees, page, itemsPerPage, totalEmployees, buikLoading, deletingIds } =
  storeToRefs(employeeStore)

async function onApply() {
  await employeeStore.handleBuilAction()
}
</script>

<template>
  <div>
    <PageTitle title="Employee List" subtitle="View and manage all employees.">
      <RouterLink to="/dashboard/employee/add">
        <Button class="button-primary-outline">Add New Employee</Button>
      </RouterLink>
    </PageTitle>
      ...
      <Table>
        <TableHeader>
          <TableRow>
            ...
            <TableHead class="min-w-35">First Name</TableHead>
            <TableHead class="min-w-35">Last Name</TableHead>
            <TableHead class="min-w-35">Username</TableHead>
            <TableHead class="min-w-50">Email</TableHead>
            <TableHead class="min-w-30">Phone</TableHead>
