...
if (pageParam) {
  scheduleStore.page = Number(pageParam)
} else {
...
const { paginatedSchedules, page, itemsPerPage, totalSchedules, bulkLoading, deletingIds } =
  storeToRefs(scheduleStore)

async function onApply() {
  await scheduleStore.handleBuilAction()
}
</script>

<template>
  <div>
    <PageTitle title="Schedule List" subtitle="View and manage all schedules.">
      <RouterLink to="/dashboard/schedule/add">
        <Button class="button-primary-outline">Add New Schedule</Button>
      </RouterLink>
    </PageTitle>
      ...
      <Table>
        <TableHeader>
          <TableRow>
            ...
            <TableHead class="min-w-30">Employee</TableHead>
            <TableHead class="min-w-30">Client</TableHead>
            <TableHead class="min-w-35">Start</TableHead>
            <TableHead class="min-w-35">End</TableHead>
            <TableHead class="min-w-35">Location</TableHead>
